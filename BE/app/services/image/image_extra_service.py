...
from dto.image_detail_dto import ImageDepartmentPermissionDeleteRequest, ImageUserPermissionDeleteRequest, ImagePermissionDeleteResponse, AuthDetail, ImageDepartmentPermissionAddRequest, ImagePermissionAddResponse, ImageDetailTagAddRequest, ImageDetailTagAddResponse, ImageDetailTagDeleteRequest, ImageDetailTagDeleteResponse, ImageUserPermissionAddRequest
...
class ImageExtraService:
    ...
    # 6. 유저 권한 삭제
    async def remove_user_image_permission(self, request: ImageUserPermissionDeleteRequest) -> ImagePermissionDeleteResponse:
    ...
    # 7. 부서 권한 삭제
    async def remove_department_image_permission(self, request: ImageDepartmentPermissionDeleteRequest) -> ImagePermissionDeleteResponse:
