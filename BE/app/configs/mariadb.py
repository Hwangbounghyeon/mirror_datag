...
# EC2 Docker Network
SQLALCHEMY_DATABASE_URL = f"mysql+pymysql://{os.getenv('MARIA_USER')}:{os.getenv('MARIA_PASSWORD')}@{os.getenv('MARIA_HOST')}:{int(os.getenv('MARIA_PORT'))}/{os.getenv('MARIA_DATABASE')}"
