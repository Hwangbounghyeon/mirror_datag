  ...
  return (
    <div>
      <ModalHeader className="flex flex-col gap-1">
        <h2 className="text-2xl font-bold text-gray-800">Analysis Configuration</h2>
      </ModalHeader>
      <ModalBody>
        <Card className="p-6 bg-gray-50 w-full" onClick={preventClick}>
          <div className="space-y-6">
            {/* Analysis Name Section */}
            <div className="space-y-2 w-full">
              <label className="text-sm font-semibold text-gray-700">분석명</label>
              <Input
                value={historyName}
                ...
                classNames={{
                  ...
                  mainWrapper: "h-full",
                  input: "text-base",
                  inputWrapper: "h-10 bg-white shadow-sm border-2 hover:border-primary focus:border-primary"
                }}
            ...
            <div className="space-y-2 w-full">
              ...
              >
                <Radio
                  value="tsne"
                  classNames={{
                    base: "bg-white p-1 border-2 rounded-lg data-[selected=true]:border-primary me-[0.5rem] ms-[0.2rem] min-w-[100px]",
                ...
                <Radio
                  value="umap"
                  classNames={{
                    base: "bg-white p-1 border-2 rounded-lg data-[selected=true]:border-primary min-w-[100px]",
                    wrapper: "before:bg-primary",
                    label: "text-sm font-medium"
                  }}
                >
