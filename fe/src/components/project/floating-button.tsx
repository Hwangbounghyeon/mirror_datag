  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <div className="relative">
        ...
        {/* Sub Buttons */}
        <div className={`absolute right-0 flex flex-col gap-4 transition-all duration-300 ease-in-out ${
          isVisible ? '-top-[9rem] opacity-100' : 'top-0 opacity-0 pointer-events-none'
        }`}>
          <Button 
            className="w-14 h-14 rounded-full p-0 min-w-0 shadow-lg hover:scale-110 transition-transform duration-200"
            color="primary" 
